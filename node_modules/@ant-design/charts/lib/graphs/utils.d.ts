import { MiniMapConfig, CardNodeCfg, IArrowConfig, FlowGraphDatum, CommonConfig, IGraph, Graph, IGroup, EdgeConfig, NodeConfig, ModelConfig, MarkerCfg } from './interface';
...
export declare const bindSourceMapCollapseEvents: (graph: IGraph, fullData: FundFlowGraphConfig['data'] | FlowGraphDatum | undefined) => void;
/**
...
export declare const getStyle: (source: unknown, cfg: CardNodeCfg | ModelConfig, item?: IGroup | undefined, current?: string | number | undefined) => any;
