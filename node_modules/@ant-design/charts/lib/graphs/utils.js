...
var getStatusBBox = function (cfg) {
    ...
    var _c = exports.getSize(size), width = _c[0], height = _c[1];
    var appendPadding = [];
    switch (position) {
        case 'top':
...
var getStatusCfg = function (cfg, cardSize) {
    ...
    var _d = exports.getSize(size), width = _d[0], height = _d[1];
    ...
    switch (position) {
        ...
        case 'left':
            ...
            break;
        case 'right':
            x = cardWidth - (util_1.isNumber(width) ? width : DefaultStatusBarWidth);
            y = 0;
            w = width !== null && width !== void 0 ? width : DefaultStatusBarWidth;
            h = height !== null && height !== void 0 ? height : cardHeight;
            break;
        case 'bottom':
            x = 0;
            y = cardHeight - (util_1.isNumber(height) ? height : DefaultStatusBarWidth);
            w = width !== null && width !== void 0 ? width : cardWidth;
            h = height !== null && height !== void 0 ? height : DefaultStatusBarWidth;
            break;
    }
...
var createMarker = function (cfg, group, size) {
    ...
    if (show) {
        group.addShape('marker', {
            attrs: __assign(__assign(__assign({}, exports.getMarkerPosition(position, size)), { r: 6, cursor: 'pointer', symbol: collapsed ? g6_1.default.Marker.expand : g6_1.default.Marker.collapse, stroke: constants_1.defaultCardStyle.stroke, lineWidth: 1, fill: '#fff' }), style),
