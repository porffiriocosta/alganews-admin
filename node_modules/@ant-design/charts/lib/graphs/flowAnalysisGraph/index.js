...
var customItem_1 = require("./customItem");
var graphs = {};
...
var FlowAnalysisGraph = function (props) {
    ...
    react_1.useEffect(function () {
        ...
        if (markerCfg) {
            utils_1.bindSourceMapCollapseEvents(graph, data);
        }
        utils_1.renderGraph(graph, data, autoFit, adjustLayout);
        if (onReady) {
            onReady(graph);
        }
        return function () {
...
exports.default = FlowAnalysisGraph;
