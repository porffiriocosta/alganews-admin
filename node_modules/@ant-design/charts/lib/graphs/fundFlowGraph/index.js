...
var graphs = {};
customItem_1.registerFundFlowItems();
var defaultLayout = {
    type: 'dagre',
    rankdir: 'LR',
    nodesep: 30,
...
var getEdgeStateStyles = function (edgeStateStyles) {
    ...
    return {
        hover: __assign(__assign({}, hover), { endArrow: endArrow ? utils_1.getArrowCfg(endArrow) : false, startArrow: startArrow ? utils_1.getArrowCfg(startArrow) : false }),
    };
};
